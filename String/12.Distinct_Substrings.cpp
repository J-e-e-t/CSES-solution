...
//A suffix array solution can be found https://cp-algorithms.com/string/suffix-array.html#practice-problems. My solution below uses suffix automaton, explanation is here https://cp-algorithms.com/string/suffix-automaton.html#algorithm. 
#include <bits/stdc++.h>
using namespace std;
using ll = long long;
struct SuffixAuto {
