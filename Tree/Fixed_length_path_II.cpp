...
Given a tree of n
nodes, your task is to count the number of distinct paths that have at least k1 and at most k2 edges.
...
CSES Fixed-Length Paths I's solution.
...
and with small-to-large merging in a single DFS instead of
