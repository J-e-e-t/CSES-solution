...
After this, there are n lines each consisting of n integers. The ith line consists of integers ci1,ci2,…,cin: the cost of each task when it is assigned to the ith employee.
